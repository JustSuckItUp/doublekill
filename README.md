...
**通过代码优化并独立开发Plugin，实现了fp32、fp16以及int8模式下的优化，并获得优良的优化效果。fp32精度下，利用polygraphy对误差进行校验，并通过校验，fps提升29.43倍；fp16精度下，利用polygraphy对误差进行校验，并通过校验，fps提升51.52倍。INT8模式下没有通过polygraphy误差校验，FPS提升27.58倍。**
