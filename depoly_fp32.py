#!/usr/bin/env python3
# Template auto-generated by polygraphy [v0.36.2] on 06/27/22 at 15:32:10
# Generation Command: /usr/local/bin/polygraphy run mobilevit.onnx --onnxrt --trt --workspace 22G --save-engine=mobilevit_fp32.plan --atol 1e-3 --rtol 1e-3 --verbose --gen-script ./depoly_fp32.py --trt-min-shapes modelInput:[1,3,256,256] --trt-opt-shapes modelInput:[16,3,256,256] --trt-max-shapes modelInput:[32,3,256,256] --input-shapes modelInput:[1,3,256,256]
...
save_engine = SaveEngine(build_engine, path='mobilevit_fp32.plan')
